...
export default function TableComponent({ data }: TableProps) {
    return (
        ...
        <div className="overflow-x-auto w-full p-5 table-container">
                        ...
                        <table className="min-w-max w-full table-auto">
                            <thead className="rounded-t-2xl">
                                <tr className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                    ...
                                    <th className="py-3 px-6 text-center">desk</th>
                                    {/* <th className="py-3 px-6 text-center">Status</th> */}
                                        ...
                                        return (
                                            <tr className="border-b border-gray-200 hover:bg-gray-100" key={index}>
                                                <td className="py-3 px-6 whitespace-nowrap">
                                                    <div className="font-medium flex items-center justify-center gap-5">
                                                        <Image src="/default-user.png" alt="profile-img" width="30" height="30" />{data.username}
                                                    </div>
                                                </td>
